import { deprecatedPropType, deprecatedColorValue, hexToRgb, decomposeColor, getLuminance, getContrastRatio, applyVariations, getPaletteColor, hasPaletteColor, getTextColorOn, getByPalette, color, borders, createTheme, } from '.';
describe('utils', () => {
    ...
    describe('deprecatedColorValue', () => {
        test('returns an error when when using a deprecated color prop value', () => {
            expect(deprecatedColorValue()({
                color: 'blue',
                theme: createTheme(),
            }, 'color', 'Component')).toBeTruthy();
        });
        test('returns undefined when using a valid palette color', () => {
            expect(deprecatedColorValue()({
                color: 'primary',
                theme: createTheme(),
            }, 'color', 'Component')).toBeUndefined();
            expect(deprecatedColorValue()({
                color: 'primary.base',
                theme: createTheme(),
            }, 'color', 'Component')).toBeUndefined();
    ...
    describe('applyVariations', () => {
        test('applies component style overrides', () => {
            ...
            expect(override[1](props)).toEqual(props.theme.componentStyles.Button.primary);
        });
        test('applies variations with component style overrides', () => {
            ...
            expect(override[3](props)).toEqual(props.theme.componentStyles.Button.outline.primary);
        });
    });
    describe('getPaletteColor', () => {
        ...
        test('returns a palette shade when provided a color prop', () => {
            expect(getPaletteColor('base')(Object.assign(Object.assign({}, props), { color: 'primary' }))).toEqual(props.theme.palette.primary.base);
            expect(getPaletteColor('base')(Object.assign(Object.assign({}, props), { color: 'primary.dark' }))).toEqual(props.theme.palette.primary.dark);
            // legacy support
            expect(getPaletteColor('base')(Object.assign(Object.assign({}, props), { color: 'orange' }))).toEqual(props.theme.colors.orange);
            expect(getPaletteColor('base')(Object.assign(Object.assign({}, props), { color: '#ffffff' }))).toEqual('#ffffff');
        });
    });
    ...
    describe('getTextColorOn', () => {
        ...
        test('returns correct text color with custom contrast ratio', () => {
            expect(getTextColorOn('primary.dark')({
                theme: Object.assign(Object.assign({}, props.theme), { contrastRatio: 9.2 }),
            })).toEqual(props.theme.palette.text.base);
        });
        test('can be driven by a color prop', () => {
            expect(getTextColorOn('light')(Object.assign(Object.assign({}, props), { color: 'primary' }))).toEqual(props.theme.palette.text.base);
            expect(getTextColorOn('dark')(Object.assign(Object.assign({}, props), { color: 'primary' }))).toEqual(props.theme.palette.text.lightest);
        });
    });
    describe('getByPalette', () => {
        test('returns the correct style', () => {
            const props = { theme: createTheme(), bg: 'background', color: 'primary' };
            expect(getByPalette(props)).toEqual(expect.arrayContaining([
                '\n  background-color: ',
    ...
    describe('color', () => {
        ...
        test('returns the correct style', () => {
            expect(color(Object.assign(Object.assign({}, props), { bg: 'background' }))).toEqual(expect.arrayContaining([
                '\n      background-color: ',
                props.theme.palette.background.base,
            ]));
            expect(color(Object.assign(Object.assign({}, props), { color: 'primary' }))).toEqual(expect.arrayContaining([
                '\n      background-color: ',
                props.theme.palette.primary.base,
                ';\n      color: ',
                props.theme.palette.text.lightest,
            ]));
            expect(color(Object.assign(Object.assign({}, props), { color: 'notify' }))).toEqual(expect.arrayContaining([
                '\n      background-color: ',
                props.theme.palette.notify.base,
                ';\n      color: ',
                props.theme.palette.text.base,
            ]));
            expect(color(Object.assign(Object.assign({}, props), { bg: 'background', color: 'primary' }))).toEqual(expect.arrayContaining([
                '\n  background-color: ',
                props.theme.palette.background.base,
                ';\n  color: ',
                props.theme.palette.primary.base,
            ...
            // legacy support
            expect(color(Object.assign(Object.assign({}, props), { color: 'text' }))).toEqual(expect.arrayContaining(['\n          color: ', props.theme.colors.text]));
            expect(color(Object.assign(Object.assign({}, props), { color: 'blue' }))).toEqual(expect.arrayContaining(['\n      color: ', props.theme.colors.blue]));
            expect(color(Object.assign(Object.assign({}, props), { color: 'blue', bg: 'green' }))).toEqual(expect.arrayContaining([
                '\n  background-color: ',
    ...
    describe('borders', () => {
        test('returns the correct style', () => {
            ...
            expect(borders(Object.assign(Object.assign({}, props), { color: 'primary' }))).toEqual({
                'border-color': props.theme.palette.primary.base,
                ':focus': {
                    outline: 0,
                    'border-color': props.theme.palette.primary.base,
