...
describe('Card', () => {
  test('renders small box shadow with default border', () => {
    ...
    expect(json).toHaveStyleRule('box-shadow', '0 0 2px 0 rgba(0,0,0,.08),0 1px 4px 0 rgba(0,0,0,.16)')
  ...
  test('renders medium box shadow with default border', () => {
    ...
    expect(json).toMatchSnapshot()
    expect(json).toHaveStyleRule('box-shadow', '0 0 2px 0 rgba(0,0,0,.08),0 2px 8px 0 rgba(0,0,0,.16)')
    expect(json).toHaveStyleRule('border', `1px solid ${theme.colors.borderGray}`)
    expect(json).toHaveStyleRule('border-radius', theme.radius)
  })
  ...
  test('renders large box shadow with default border', () => {
    ...
    expect(json).toMatchSnapshot()
    expect(json).toHaveStyleRule('box-shadow', '0 0 2px 0 rgba(0,0,0,.08),0 4px 16px 0 rgba(0,0,0,.16)')
    expect(json).toHaveStyleRule('border', `1px solid ${theme.colors.borderGray}`)
    expect(json).toHaveStyleRule('border-radius', theme.radius)
  })
  ...
  test('renders xlarge box shadow with default border', () => {
    ...
    expect(json).toMatchSnapshot()
    expect(json).toHaveStyleRule('box-shadow', '0 0 2px 0 rgba(0,0,0,.08),0 8px 32px 0 rgba(0,0,0,.16)')
    expect(json).toHaveStyleRule('border', `1px solid ${theme.colors.borderGray}`)
    expect(json).toHaveStyleRule('border-radius', theme.radius)
  })
