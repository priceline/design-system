...
describe('getVisibleSlidesArray', () => {
  ...
  it('int visible slides', () => {
    expect(getVisibleSlides(3)).toEqual([1 / 1.2, 1 / 2.2, 1 / 3])
  })
})

describe('getCustomWidths', () => {
  it('First slide', () => {
    expect(getCustomWidths([60, 40], 0)).toEqual([1 / 1.2, 1 / 2.2, '60%'])
  })
  it('Second slide', () => {
    expect(getCustomWidths([60, 40], 1)).toEqual([1 / 1.2, 1 / 2.2, '40%'])
  })
})
