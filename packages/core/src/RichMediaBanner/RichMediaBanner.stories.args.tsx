export const defaultArgs = {
  ...
  media: undefined,
  badge: '',
  heading: 'Special deal',
  paragraph: 'You saved 20% on this stay!',
...
export const defaultImageArgs = {
  ...defaultArgs,
  icon: undefined,
  heading: 'Save up to 40% on hotels in Las Vegas',
  paragraph: 'Your hotel booking unlocks VIP bundle deals.',
  callToAction: undefined,
  borderHugPosition: undefined,
}
