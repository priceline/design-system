...
export const ResponsiveTypographyVsFontSize = () => (
  <>
    ...
    <Text textStyle={['heading2', null, null, 'heading1']}>Words and stuff</Text>
    ...
    <Text textStyle={['subheading5', null, null, 'subheading3']}>Words and stuff</Text>
    <Text>Expected (subheading):</Text>
    <Text fontSize={['3', null, null, '4']}>Words and stuff</Text>
  </>
)
