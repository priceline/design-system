 ...
 * @public
 */
export const StyledHrDivider: React.FC<DividerProps> = styled.hr.attrs(({ mx, ml, mr }) => ({
  ml: mx ? null : ml,
  mr: mx ? null : mr,
}))`
  border: 0;
 ...
 * @public
 */
export function Divider({ color = 'border', ml = 0, mr = 0, ...props }: DividerProps) {
  return <StyledHrDivider color={color} ml={ml} mr={mr} {...props} />
}
