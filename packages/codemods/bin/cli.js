...
const TRANSFORMER_INQUIRER_CHOICES = [
  {
    name:
      'button-fullwidth-to-width: Replaces Button\'s fullWidth prop using width',
    value: 'button-fullwidth-to-width'
  },
  {
    name:
        'rename-deprecated-props-flex: Renames deprecated props on Flex elements',
    value: 'rename-deprecated-props-flex'
  },
  {
    name:
        'rename-deprecated-props-text: Renames deprecated props on Text elements',
  ...
  inquirer
    .prompt([
      ...
      // if transformer === 'class'
      {
        ...
        when: answers => {
          return cli.input[0] === 'button-fullwidth-to-width' || answers.transformer === 'button-fullwidth-to-width';
        },
